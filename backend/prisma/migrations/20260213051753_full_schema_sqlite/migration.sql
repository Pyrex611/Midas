-- AlterTable
ALTER TABLE "Campaign" ADD COLUMN "context" TEXT;
...
INSERT INTO "new_Draft" ("body", "createdAt", "id", "isActive", "replyCount", "sentCount", "subject", "tone", "updatedAt", "useCase", "version") SELECT "body", "createdAt", "id", "isActive", "replyCount", "sentCount", "subject", "tone", "updatedAt", "useCase", "version" FROM "Draft";
DROP TABLE "Draft";
