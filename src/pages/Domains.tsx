...
export const Domains: React.FC = () => {
  ...
  const handleAddDomain = async (e: React.FormEvent) => {
    ...
    setAdding(true);
    try {
      await axios.post('/api/domains', { domainName: newDomain });
      setNewDomain('');
      fetchDomains();
    } catch (err: any) {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 pt-20">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <p className="text-sm text-gray-600 mb-4">We highly recommend using subdomains (e.g., outreach.yourdomain.com) to protect your root domain reputation.</p>
